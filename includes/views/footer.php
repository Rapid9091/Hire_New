<footer class="footer">
        ...
        <div class="footer-strip-blocks grid">
            ...
            <div class="footer-strip-blocks-content">
                <address>
                    ...
                    <p>
                        <a href="https://www.google.com/maps/place/Rapid+Auto+Shipping/@34.4686156,-101.3040011,3a,64.1y,225.98h,87.97t/data=!3m6!1e1!3m4!1smO6Tx6ID-QAIY-cItwzHog!2e0!7i16384!8i8192!4m5!3m4!1s0x0:0x9f3bfd5545d14ae8!8m2!3d34.4683842!4d-101.3042842?hl=en" title="Live location">Silverton Texas USA-79257</a>
                    </p>
                </address>
            </div>
        </div>
    ...
    <div class="footer-grid-container grid">
        ...
        <div class="footer-links">
            ...
            <ul>
              <li><a href="<?= home_path() ?>" target="_blank">Coworker</a></li>
              <li><a href="https://pksolutions.org/" target="_blank">Pk Solutions</a></li>
              <li><a href="http://flempegsolutions.com/" target="_blank">Flempeg Solutions</a></li>
        ...
        <div class="social-icons flex-center">
            ...
            <address class="">
                ...
                <a href="https://twitter.com/hirecoworker" target="_blank">
                 <img width="30px" height="30px" src="<?= get_img() ?>twitter-icon.webp" alt="HireCoworker twitter" loading="lazy" />
...
<path fill="#03A9F4" d="M42,12.429c-1.323,0.586-2.746,0.977-4.247,1.162c1.526-0.906,2.7-2.351,3.251-4.058c-1.428,0.837-3.01,1.452-4.693,1.776C34.967,9.884,33.05,9,30.926,9c-4.08,0-7.387,3.278-7.387,7.32c0,0.572,0.067,1.129,0.193,1.67c-6.138-0.308-11.582-3.226-15.224-7.654c-0.64,1.082-1,2.349-1,3.686c0,2.541,1.301,4.778,3.285,6.096c-1.211-0.037-2.351-0.374-3.349-0.914c0,0.022,0,0.055,0,0.086c0,3.551,2.547,6.508,5.923,7.181c-0.617,0.169-1.269,0.263-1.941,0.263c-0.477,0-0.942-0.054-1.392-0.135c0.94,2.902,3.667,5.023,6.898,5.086c-2.528,1.96-5.712,3.134-9.174,3.134c-0.598,0-1.183-0.034-1.761-0.104C9.268,36.786,13.152,38,17.321,38c13.585,0,21.017-11.156,21.017-20.834c0-0.317-0.01-0.633-0.025-0.945C39.763,15.197,41.013,13.905,42,12.429"></path>
        ...
        <p class="grid-center">Copyright © 2018- <?= date("Y"); ?>, HireCoWorker- All Rights Reserved.</p>
    </div>
</section>
