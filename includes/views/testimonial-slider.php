...
<section class="testimonial-section">
    ...
    <div class="owl-carousel text-tesimonial owl-theme" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500" data-aos-delay="50">
            ...
            <div class="test-user flex-center">
                   <div class="user-img">
                    ...
                    <div class="test-user-dtl">
                        ...
                        <p><strong><?= isset($test_name1) ? $test_name1 : "John Doe"; ?></strong></p>
                    </div>
            </div>
        ...
        <div class="item">
            ...
            <div class="test-user flex-center">
                   <div class="user-img">
                        <img src="<?= isset($user_img2) ? get_img($user_img2) : get_img("testimonial/male-user.png"); ?>" alt="" width="100%" height="100%" loading="lazy">
                    </div>
                    <div class="test-user-dtl">
                        <!-- <p class="test_name_designation"><?= isset($test_role1) ? $test_role1 : "Graphic Designer"; ?></p> -->
                        <p><strong><?= isset($test_name2) ? $test_name2 : "John Doe"; ?></strong></p>
                    </div>
            </div>
                <!-- <p class="qoute"><i class='bx bxs-quote-alt-left'></i></p> -->
                <div class="test-dtl">
        ...
        <div class="item">
            ...
            <div class="test-user flex-center">
                   <div class="user-img">
                    ...
                    <div class="test-user-dtl">
                        <!-- <p class="test_name_designation"><?= isset($test_role1) ? $test_role1 : "Graphic Designer"; ?></p> -->
                        <p><strong><?= isset($test_name3) ? $test_name3 : "John Doe"; ?></strong></p>
                    </div>
            </div>
                <!-- <p class="qoute"><i class='bx bxs-quote-alt-left'></i></p> -->
                <div class="test-dtl">
        ...
        <div class="item">
            ...
            <div class="test-user flex-center">
                   <div class="user-img">
                    ...
                    <div class="test-user-dtl">
                        <!-- <p class="test_name_designation"><?= isset($test_role1) ? $test_role1 : "Graphic Designer"; ?></p> -->
                        <p><strong><?= isset($test_name4) ? $test_name4 : "John Doe"; ?></strong></p>
                    </div>
            </div>
                <!-- <p class="qoute"><i class='bx bxs-quote-alt-left'></i></p> -->
                <div class="test-dtl">
