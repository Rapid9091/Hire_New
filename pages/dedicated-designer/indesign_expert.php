...
<head>
    <title>HireCoworker | Hire Adobe InDesign Experts</title>
    ...
    <style>
        .landing-section-services {
            background-image: url("<?= get_img() ?>designer/indesign.jpg");
        }
    </style>
</head>
...
<body>
    <div class="landing-section-services" id="hire">
        ...
        <div class="landing-section-parent grid grid-2">
            <div class="landing-section-content">
                ...
                <br>
                <a class="basic-button landing-btn" href="#">Hire ADOBE InDESIGN EXPERTS
    ...
    <section class="full-section" id="full-section">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">
            OUR ALL ADOBE InDESIGN SERVICES
        </h4>
        <div class="container-grid grid grid-3">
                ...
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/painting.png" alt="design services"
                                loading="lazy">
                        </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/graphic-design.png" alt="desktop publishing"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/responsive.png" alt="InDesign to Kindle Conversion"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>InDesign to Kindle Conversion</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/2d.png" alt="InDesign Conversion"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>InDesign Conversion</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/website-template.png" alt="Web To Print Design" loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>Web To Print Design</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/typo.png" alt="InDesign Server Integration"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>InDesign Server Integration</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/blog.png" alt="Text Formatting"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/cms.png" alt="Workflow Automation"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/application-design.png" alt="InDesign Plugin Development"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>InDesign Plugin Development</h5>
                        </div>
                    </div>
    ...
    <section class="why_content_writing">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">WHO LIKES TO HIRE INDESIGN EXPERTS</h4>
            ...
            <div class="reason-side">
                <div class="reason-side-item left-item">
                    ...
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/technology.png" alt="Software" loading="lazy">
                    </div>
                </div>
                <div class="reason-side-item left-item">
                    <div class="reason-dtl">
                    ...
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/graduation.png" alt="Higher Education" loading="lazy">
                    </div>
                </div>
                <div class="reason-side-item left-item">
                    <div class="reason-dtl">
                    ...
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/bank.png" alt="Travel & Tourism">
                    </div>
                </div>
            </div>
            <div class="reason_center_img" data-aos="zoom-in" data-aos-duration="400">
                <img src="<?= get_img(); ?>designer/photoshop_expert.png" width="100%" alt="hire logo designer">

            </div>
            <div class="reason-side">
                <div class="reason-side-item right-item">
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/ads.png" alt="Marketing and Advertising" width="32px">
                    </div>
                    <div class="reason-dtl">
                ...
                <div class="reason-side-item right-item">
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/healthcare.png" width="32px"alt="Hospitals & Healthcare" loading="lazy">
                    </div>
                    <div class="reason-dtl">
                ...
                <div class="reason-side-item right-item">
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/mass-media.png" alt="Publishing">
                    </div>
                    <div class="reason-dtl">
                        <p>Publishing</p>
                    </div>
    ...
    <section class="services-types" style="background-color:#F1F8FB; padding: 5% 8%;">
        ...
        <h3 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500"
            data-aos-delay="100">BENIFITS OF HIRING InDESIGN EXPERTS FROM COWORKER</h3>
        <div class="why_about">
    ...
    <section class="experts-section">
        ...
        <h3 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">HIRE OUR
            BEST InDesign EXPERTS</h3>
        <div class="expert-grid">
        <div class="expert-item">
                <div class="expert-image-box">
                    <img src="<?= get_img() ?>designer/ankita.jpg" class="expert-image" alt="hire indesign expert" loading="lazy">
                </div>
                <div class="expert-profile text-center">
                    <h2>ANKITA M.</h2>
                    <P class="light-grey">ADOBE InDesign EXPERT</P>
            ...
            <div class="expert-item">
                <div class="expert-image-box">
                    <img src="<?= get_img() ?>designer/daug.jpg" class="expert-image" alt="hire indesign experts" loading="lazy">
                </div>
                <div class="expert-profile">
                    <h2 class="text-center">DAUG L.</h2>
                    <P class="light-grey">ADOBE InDESIGN EXPERT</P>
                    <div class="expert-rating text-center">
                        <i class='bx bxs-star'></i>
            ...
            <div class="expert-item">
                <div class="expert-image-box">
                    <img src="<?= get_img() ?>designer/diana.jpg" class="expert-image" alt="hire indesign experts" loading="lazy">
                </div>
                <div class="expert-profile">
                    <h2 class="text-center">DIANA A.</h2>
                    <P class="light-grey">ADOBE InDESIGN EXPERT</P>
                    <div class="expert-rating text-center">
                        <i class='bx bxs-star'></i>
    ...
    <section class="roadmap-2">
        ...
        <h3 class="section-heading ">OUR EXPERTS FOLLOW THESE STEPS</h3>
        <div class="timeline">
