...
<head>
    ...
    <style>
        .landing-section-services {
            background-image: url("<?= get_img() ?>designer/photoshop-artists.jpg");
        }
    </style>
</head>
...
<body>
    <div class="landing-section-services" id="hire">
        ...
        <div class="landing-section-parent grid grid-2">
            <div class="landing-section-content">
                ...
                <br>
                <a class="basic-button landing-btn" href="#">Hire DEDICATED PHOTOSHOP ARTISTS
    ...
    <section class="full-section" id="full-section">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">
            OUR COMPLETE RANGE OF PHOTOSHOP SERVICES
        </h4>
        <div class="container-grid grid grid-3">
                ...
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/image_editing.png" alt="PHOTO & IMAGE EDITING"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>PHOTO & IMAGE EDITING</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/3d_texture.png" alt="2D, 3D PATTTERN / TEXTURE"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>2D, 3D PATTTERN / TEXTURE</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/politics.png" alt="POLITICS AND SOCIAL MEDIA"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>POLITICS AND SOCIAL MEDIA</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/ux-design.png" alt="UI / UX DESIGN"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>UI / UX DESIGN</h5>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/logo.png" alt="LOGO DESIGN & BRANDING" loading="lazy">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/illustration.png" alt="ILLUSTRATION"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>ILLUSTRATION</h5>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/painting.png" alt="PAINTING & COLORING"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>PAINTING & COLORING</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/quotes.png" alt="DESIGNING QUOTES IMAGES"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>DESIGNING QUOTES IMAGES</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/gif.png" alt="GIF ANIMATION"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>GIF ANIMATION</h5>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/icon.png" alt="ICON DESIGN"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>ICON DESIGN</h5>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/ecommerce.png"
                                alt="E-COMMERCE PRODUCT DESIGN" loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>E-COMMERCE PRODUCT DESIGN</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/game.png" alt="GAME BACKGROUNDS"
                                loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>GAME BACKGROUNDS</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/website-template.png"
                                alt="WEBSITE TEMPLATE" loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>WEBSITE TEMPLATE</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/caricature.png"
                                alt="CARICATURE DESING & ILLUSTRATION" loading="lazy">
                        </div>
                        <div class="box-title-heading">
                            <h5>CARICATURE DESING & ILLUSTRATION</h5>
                        </div>
                    </div>
            ...
            <div class="container-section-boxes more less">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>designer/retouching.png"
                                alt="PHOTO RETOUCHING" loading="lazy">
                        </div>
                        <div class="box-title-heading">
    ...
    <section class="why_content_writing">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">WHO
            OUTSOURCE PHOTOSHOP DESIGN SERVICES</h4>
        <div class="flex content-reason">
            <div class="reason-side">
                <div class="reason-side-item left-item">
                    ...
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/camera.png" alt="Photography Studio" loading="lazy">
                    </div>
                </div>
                <div class="reason-side-item left-item">
                    <div class="reason-dtl">
                    ...
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/wedding.png" alt="Wedding Planner" loading="lazy">
                    </div>
                </div>
                <div class="reason-side-item left-item">
                    <div class="reason-dtl">
            ...
            <div class="reason_center_img" data-aos="zoom-in" data-aos-duration="400">
                <img src="<?= get_img(); ?>designer/photoshop_expert.png" width="100%" alt="hire photoshop expert">
            ...
            <div class="reason-side">
                ...
                <div class="reason-side-item right-item">
                    <div class="reason-side-icon">
                        <img src="<?= get_img(); ?>designer/technology.png" alt="SCIENCE & TECHNOLOGY" loading="lazy">
                    </div>
                    <div class="reason-dtl">
    ...
    <section class="services-types" style="background-color:#F1F8FB; padding: 5% 8%;">
        ...
        <h3 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500"
            data-aos-delay="100">BENIFITS TO HIRE PHOTOSHOP EXPERTS FROM COWORKER</h3>
        <div class="why_about">
            ...
            <div class="vedio_test_row">
                ...
                <div class="vedio_frame">
                    <a class="fancybox" href="https://youtube.com/watch?v=h8tjQDpaE-c&feature=shares"><img
                            src="<?= get_img()?>coworker_vid.jpeg" alt="hire photoshop expert" class="width-100"></a>
                </div>
            </div>
    ...
    <section class="roadmap-2">
        ...
        <h3 class="section-heading ">OUR 5-STEPS OF PHOTOSHOP TECHNIQUES</h3>
        <div class="timeline">
    ...
    <section class="hiring_step">
        ...
        <div class="grid  why-row" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500">
            <div class="hiring_step_order-1">
                <div>
                    <h3 class="section-heading">HIRE PHOTOSHOP EXPERTS ONLINE WITH EASY STEP</h3>
                    ...
                    <button class="btn hire-btn">Hire Photoshop Experts</button>
                </div>
            </div>
            <div>
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img()?>engineer-architecture/brief.png" alt="hire photoshop expert"
                            loading="lazy">
                    </div>
                    <div class="step-dtl">
                        <h4>Talk To Us</h4>
                ...
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img()?>engineer-architecture/team.png" alt="hire photoshop expert"
                            loading="lazy">
                    </div>
                    <div class="step-dtl">
                ...
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img()?>engineer-architecture/going.png" alt="hire photoshop expert"
                            loading="lazy">
                    </div>
                    <div class="step-dtl">
                        <h4>Get Going</h4>
