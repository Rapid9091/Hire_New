...
<head>
    ...
    <style>
        .landing-section-services {
            background-image: url("<?= get_img() ?>mobile-apps/mobile-apps.jpg");
        }
    </style>
    ...
    <section class="full-section" id="full-section">
        ...
        <div class="container-grid grid grid-3">
            ...
            <div class="container-section-boxes more less" id="more">
                ...
                <p class="text">
                    Our mobile app developers for hire not only build apps from scratch but also keep your apps up and running.
            ...
            <div class="container-section-boxes more less" id="more">
                ...
                <p class="text">
                    Augmented reality is the future (and the present). Tap into the massive industry with state-of-the-art apps built by HireCoworker developers.
                </p>
            </div>
