            ...
            <div class="landing-section-content">
                ...
                <ul class="landing-ul">
                    <li class="flex-center">
                        ...
                        <p class="text">
                            Hire IT Expert at $5 per hour </p>
                    </li>
                    <li class="flex-center">
                        <ion-icon name="checkmark-done-outline"></ion-icon>
                        <p class="text">
                            Your Entire remote team works together for easy collaboration</p>
                    </li>
                    <li class="flex-center">
                        <ion-icon name="checkmark-done-outline"></ion-icon>
                        <p class="text">
                            We have the team of the professional having 9+ years of experience </p>
                    </li>
                </ul>
                <br>
                <a class="basic-button landing-btn" href="#">Hire IT Experts
...
<div class="grid12  why-row" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500">
    ...
    <section class="it-services padding">
        ...
        <div class="it-services-grid grid">
            ...
            <div class="it-services-grid-1  grid-center">
                <a href="<?=home_path()?>customer-mail-handling" class="grid-center">
            ...
            <div class="it-services-grid-1  grid-center">
                <a  href="<?=home_path()?>chargebacks-handling" class="grid-center">
            ...
            <div class="it-services-grid-1  grid-center">
                <a href="<?=home_path()?>dropshipping-virtual-assistant" class="grid-center">
            ...
            <div class="it-services-grid-1  grid-center">
                <a  href="<?=home_path()?>sales-funnel-development"  class="grid-center">
