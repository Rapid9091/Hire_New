...
<title>Hire the Most Reliable Virtual Assistants Today | Hire Co-Worker</title>
    ...
    <link rel="stylesheet" href="<?= get_css() ?>virtual-assistant/virtual-assistant.css">
    ...
    <style>
        .landing-section-services {
            background-image: url("<?= get_img() ?>virtual-assistant-bg.jpg");
        }
    </style>
</head>
        ...
        <div class="landing-section-parent grid grid-2">
            <div class="landing-section-content">
                <h1 class="main-heading">
                    Hire the best virtual assistant
                </h1>
                <div class="landing-offer-div">
                    <p>Save Upto 70% with a Virtual Assistant </p>
                </div>

                <ul class="landing-ul">
                    <li class="flex-center">
                        <ion-icon name="checkmark-done-outline"></ion-icon>
                        <p class="text"> Hire Virtual assistant at $5 per hour </p>
                    </li>
                    <li class="flex-center">
                        <ion-icon name="checkmark-done-outline"></ion-icon>
                        <p class="text"> Get your job done easily with a virtual helper </p>
                    </li>
                    <li class="flex-center">
                        <ion-icon name="checkmark-done-outline"></ion-icon>
                        <p class="text">We have the team of the professional having 9+ years of experience </p>
                    </li>
                </ul>
                <br>
                <a class="basic-button landing-btn" href="#">Hire Virtual Assistant
...
<!-- -------------------------- -->
 ...
 <section class="experts-section">
    ...
    <?php
    $username1 = "Harry Jr";
    $review_text1 = "Easy to use, intuitive and fluid interface, support always willing to assist in problems that may appear. I am in love with the interface and the services they provide. ";
    ...
    <section class="blog" id="blog">
        ...
        <h2 class="section-heading">Latest Blog & News</h2>

        <div class="blog-grid grid grid-3">
            <div class="blog-card ">
                <div class="blog-banner-box">
                    <img loading="lazy" src="<?= get_img() ?>blog/digital-marketing.jpg" alt="Digital Marketing expert" />
                </div>

                <div class="blog-content">
                    <h3 class="blog-title">
                        <a href="#">Outsourcing & Solopreneurs: A Match Made in Heaven. if You Can Avoid the Demons</a>
                    </h3>
                    ...
                    <div class="wrapper flex-center-between">
                        <div class="blog-publish-date flex-center">
                            ...
                            <a href="#">01 Aug, 2022</a>
                        </div>
                        <div class="blog-link-div">
                            <a href="#" class="basic-button">View More</a>
                        </div>
            ...
            <div class="blog-card">
                <div class="blog-banner-box">
                    <img loading="lazy" src="<?= get_img() ?>blog/content-writer.jpg" alt="Hire experts virtual employee" />
                </div>

                <div class="blog-content">
                    <h3 class="blog-title">
                        <a href="#">Here’s why Virtual Employee Model is safer than Project Outsourcing</a>
                    </h3>
            ...
            <div class="blog-card">
                <div class="blog-banner-box">
                    <img loading="lazy" src="<?= get_img() ?>blog/web-dev.jpg" alt="Hire IoT expert" />
                </div>

                <div class="blog-content">
                    <h3 class="blog-title">
                        <a href="#">Data Security: How We Keep your Sensitive Information Safe</a>
                    </h3>
