...
<head>
    ...
    <title>Hire PHP Developers</title>
    ...
    <link rel="stylesheet" href="<?= get_css() ?>hire-developers/php-developer.css">
    <style>
...
<body>
        ...
        <div class="landing-section-parent grid grid-2">
            <div class="landing-section-content">
                ...
                <div class="landing-offer-div">
                    <p>Starts from US $8/Hour - Save 70%</p>
                </div>

                <ul class="landing-ul">
                    <p class="text">Get rigorously vetted software developer teams that best match your timezone and work model. Save your hiring time and budget with Remotebase.</p>
                </ul>
                <br>
                <a class="basic-button landing-btn" href="#">Hire PHP Developers
    ...
    <section class="full-section" id="full-section">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">
            Our Dedicated Developers Have Expertise In PHP
        </h4>
        <div class="container-grid grid grid-3">
                ...
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/API-Integration.png" alt="">
                        </div>
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/Application-Migration.png" alt="">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/AR-VR-Apps.png" alt="">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/Dynamic-Apps.png" alt="">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/eCommerce-App.png" alt="">
                        </div>
                        <div class="box-title-heading">
            ...
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>php-developer/iot-app.png" alt="">
                        </div>
                        <div class="box-title-heading">
                            <h5>PHP Migration Services</h5>
                        </div>
                    </div>
    ...
    <!-- <section class="hire-services w-100">
        ...
        <p class="text text-center">
            Hire your dedicated developer with Hirecoworker. We have a track record of satisfactory project delivery, for all kinds of projects. We provides Experienced software developers, Daily/weekly/monthlyreporting, complementary development manager, Flexible engagement options & Competitive Pricing Models.
        </p>
    ...
    <section class="experts-section">
        ...
        <h3 class="section-heading ">HIRE OUR BEST CONTENT WRITER</h3>
        <div class="expert-grid">
            ...
            <div class="expert-item">
                <div class="expert-image-box">
                    <img src="<?= get_img() ?>hire-developer/dev-expert-03.jpeg" class="expert-image" alt="Hire senior front end developer" loading="lazy">
                </div>
                <div class="expert-profile">
    ...
    <!-- <section class="full-section">
        ...
        <div class="container-grid grid grid-3">
            ...
            <div class="container-section-boxes">
                ...
                <p class="text">Remote developers will only cost you the salary or decided project fees and besides that, they won’t ask for anything. They work from home or their place that saves offices extra cost of equipment, dest, furniture, and stationery.</p>
            </div>
            <div class="container-section-boxes">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
