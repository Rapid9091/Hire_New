    ...
    <section class="hiring_step">
        ...
        <div class="grid  why-row" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500">
            <div class="hiring_step_order-1">
                <div>
                    <h3 class="section-heading">HIRE ARTICLE WRITING SERVICES ONLINE WITH EASY STEP</h3>
                    ...
                    <button class="btn hire-btn">Hire Article Writer</button>
                </div>
            </div>
            <div>
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img() ?>engineer-architecture/brief.png" alt="hire article-writer" loading="lazy">
                    </div>
                    <div class="step-dtl">
                        <h4>Talk To Us</h4>
                ...
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img() ?>engineer-architecture/team.png" alt="hire article writer" loading="lazy">
                    </div>
                    <div class="step-dtl">
                ...
                <div class="steps flex">
                    <div class="step_icon">
                        <img src="<?= get_img() ?>engineer-architecture/going.png" alt="hire article writer" loading="lazy">
                    </div>
                    <div class="step-dtl">
                        <h4>Get Going</h4>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quaerat totam similique natus, sunt
