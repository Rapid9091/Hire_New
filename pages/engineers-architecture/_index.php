...
<head>
    ...
    <style>
        .landing-section-services {
            background-image: url("<?= get_img() ?>engineer-architecture/engineers-architectue.jpg");
        }
    </style>
        ...
        <div class="landing-section-parent grid grid-2">
            <div class="landing-section-content">
                <h2 class="main-heading">
                    Hire ENGINEERS & Architects
                </h2>
                <div class="landing-offer-div">
                    <p>Starts from US $5/Hour - Save upto 70%</p>
                </div>

                <ul class="landing-ul">
                    <p class="text">
                        Hire architects online with Hire Coworker and expect the same level of professionalism that you would from an in-house team.
                    </p>
                </ul>
                <br>
...
<div class="grid12  why-row" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="500">
    ...
    <section class="full-section" id="full-section">
        ...
        <h4 class="section-heading" data-aos="zoom-in" data-aos-easing="ease-in-out" data-aos-duration="400">
            OUR ENGINEERING & ARCHITECTURAL SERVICES
        </h4>
        <div class="container-grid grid grid-3">
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="100">
                ...
                <p class="text">
                    Hire architects who can provide high-quality solutions in a short amount of time and are familiar with the most recent software and hardware. The best part is that we can handle any size AutoCAD drawing project. </p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="150">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        ...
                        <div class="box-title-heading">
                            <a href="<?=home_path() ?>mechanical-engineering">
                ...
                <p class="text">
                    If you hire a mechanical engineer online, they should be able to meet all of your needs, from CAD conversion to solid modeling. This is a given for us. Additionally, we guarantee simple collaboration for improved outcomes.
                </p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="200">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>engineer-architecture/mep.png" alt="Outsource Mep engineer">
                        </div>
                        <div class="box-title-heading">
                            <a href="<?=home_path() ?>mep-engineering">
                                <h5>MEP ENGINEERING</h5>
                            </a>
                        </div>
                    </div>
                ...
                <p class="text">
                    Get experienced mechanical electrical plumbing engineers to work on plant room layout design, fire protection systems, electrical diagrams, etc. Make the most of your HVAC system, plumbing, and electricity.</p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="100">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>engineer-architecture/civil.png" alt="Outsource civil engineer">
                        </div>
                        <div class="box-title-heading">
                            <a href="<?=home_path() ?>civil-engineering">
                ...
                <p class="text">
                    HireCoworker’s online architecture design services are rendered by qualified civil engineers, with a proven track record of handling drafting and drawing projects with utmost efficiency.</p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="150">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                ...
                <p class="text">
                    HireCoworker engineers provide individualized solutions. We have what you need, whether you need broadcast equipment or a global positioning system (GPS).</p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="200">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                ...
                <p class="text">
                    In addition, our architectural and engineering services provide you with access to knowledgeable resources who are adept at implementing electrical wiring diagrams, designs, and other electrical tasks.</p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="200">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                ...
                <p class="text">
                    Outsource architectural drafting to India for all your CAD conversion and documentation requirements. We also undertake MicroStation drafting for geospatial references & metadata. </p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="200">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                ...
                <p class="text">
                    Outsource construction drawing services to HireCoworker without second thoughts, from architectural drawings to millwork drawings for cabinet and casework construction and architectural woodwork.</p>
            </div>
            <div class="container-section-boxes" data-aos="fade-up" data-aos-easing="ease-in-out" data-aos-duration="400" data-aos-delay="200">
                <div class="services-box-title ">
                    <div class="box-title-number flex-center">
                        <div class="service-img">
                            <img src="<?= get_img() ?>engineer-architecture/visualisation.png" alt="Outsource ARCHITECTURAL VISUALISATION">
                        </div>
                        <div class="box-title-heading">
                            <a href="">
                                <h5>ARCHITECTURAL VISUALISATION</h5>
                            </a>
                        </div>
                    </div>
                ...
                <p class="text">
                    Our 3D architectural visualization services can be used for walkthrough animations, virtual tours, exteriors, and interiors. Our 3D architectural rendering services also include photorealistic rendering.
                </p>
            </div>
